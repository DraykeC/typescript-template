...
export async function main(ns) {
      try
        { const result = JSON.stringify(ns.getServer('pserv-15'), jsonStringifyReplacer); if (ns.read("/Temp/-510125444-data.txt") != result) await ns.write("/Temp/-510125444-data.txt", result, 'w'); }
