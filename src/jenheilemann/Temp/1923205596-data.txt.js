...
export async function main(ns) {
      try
        { const result = JSON.stringify(ns.getServer('pserv-0'), jsonStringifyReplacer); if (ns.read("/Temp/1923205596-data.txt") != result) await ns.write("/Temp/1923205596-data.txt", result, 'w'); }
