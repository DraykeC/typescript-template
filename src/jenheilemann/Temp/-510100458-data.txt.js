...
export async function main(ns) {
      try
        { const result = JSON.stringify(ns.getServer('pserv-20'), jsonStringifyReplacer); if (ns.read("/Temp/-510100458-data.txt") != result) await ns.write("/Temp/-510100458-data.txt", result, 'w'); }
