...
export async function main(ns) {
      try
        { const result = JSON.stringify(ns.getPurchasedServerCost(65536), jsonStringifyReplacer); if (ns.read("/Temp/getPurchasedServerCost.16.txt") != result) await ns.write("/Temp/getPurchasedServerCost.16.txt", result, 'w'); }
