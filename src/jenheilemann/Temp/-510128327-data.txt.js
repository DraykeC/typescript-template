...
export async function main(ns) {
      try
        { const result = JSON.stringify(ns.getServer('pserv-12'), jsonStringifyReplacer); if (ns.read("/Temp/-510128327-data.txt") != result) await ns.write("/Temp/-510128327-data.txt", result, 'w'); }
