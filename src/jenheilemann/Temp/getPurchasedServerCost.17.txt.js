...
export async function main(ns) {
      try
        { const result = JSON.stringify(ns.getPurchasedServerCost(131072), jsonStringifyReplacer); if (ns.read("/Temp/getPurchasedServerCost.17.txt") != result) await ns.write("/Temp/getPurchasedServerCost.17.txt", result, 'w'); }
