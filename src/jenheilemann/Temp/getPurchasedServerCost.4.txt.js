...
export async function main(ns) {
      try
        { const result = JSON.stringify(ns.getPurchasedServerCost(16), jsonStringifyReplacer); if (ns.read("/Temp/getPurchasedServerCost.4.txt") != result) await ns.write("/Temp/getPurchasedServerCost.4.txt", result, 'w'); }
