...
export async function main(ns) {
      try
        { const result = JSON.stringify(ns.singularity.purchaseProgram('SQLInject.exe'), jsonStringifyReplacer); if (ns.read("/Temp/purchaseProgram.txt") != result) await ns.write("/Temp/purchaseProgram.txt", result, 'w'); }
