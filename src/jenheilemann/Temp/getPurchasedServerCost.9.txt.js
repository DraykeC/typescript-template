...
export async function main(ns) {
      try
        { const result = JSON.stringify(ns.getPurchasedServerCost(512), jsonStringifyReplacer); if (ns.read("/Temp/getPurchasedServerCost.9.txt") != result) await ns.write("/Temp/getPurchasedServerCost.9.txt", result, 'w'); }
