...
export async function main(ns) {
      try
        { const result = JSON.stringify(ns.getServer('pserv-11'), jsonStringifyReplacer); if (ns.read("/Temp/-510129288-data.txt") != result) await ns.write("/Temp/-510129288-data.txt", result, 'w'); }
