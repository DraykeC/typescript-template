...
export async function main(ns) {
      try
        { const result = JSON.stringify(ns.codingcontract.getContractType('contract-695790.cct','ecorp'), jsonStringifyReplacer); if (ns.read("/Temp/codingContract.getContractType.txt") != result) await ns.write("/Temp/codingContract.getContractType.txt", result, 'w'); }
