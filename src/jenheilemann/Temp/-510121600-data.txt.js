...
export async function main(ns) {
      try
        { const result = JSON.stringify(ns.getServer('pserv-19'), jsonStringifyReplacer); if (ns.read("/Temp/-510121600-data.txt") != result) await ns.write("/Temp/-510121600-data.txt", result, 'w'); }
