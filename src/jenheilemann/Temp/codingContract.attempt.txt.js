...
export async function main(ns) {
      try
        { const result = JSON.stringify(ns.codingcontract.attempt(
      14,
      'contract-470634-CyberSec.cct',
      'lexo-corp',
      { returnReward: true }), jsonStringifyReplacer); if (ns.read("/Temp/codingContract.attempt.txt") != result) await ns.write("/Temp/codingContract.attempt.txt", result, 'w'); }
