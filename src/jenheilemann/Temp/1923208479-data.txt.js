...
export async function main(ns) {
      try
        { const result = JSON.stringify(ns.getServer('pserv-3'), jsonStringifyReplacer); if (ns.read("/Temp/1923208479-data.txt") != result) await ns.write("/Temp/1923208479-data.txt", result, 'w'); }
