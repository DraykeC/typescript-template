...
export async function main(ns) {
      try
        { const result = JSON.stringify(ns.getServer('pserv-14'), jsonStringifyReplacer); if (ns.read("/Temp/-510126405-data.txt") != result) await ns.write("/Temp/-510126405-data.txt", result, 'w'); }
