...
export async function main(ns) {
      try
        { const result = JSON.stringify(ns.getPurchasedServerCost(4096), jsonStringifyReplacer); if (ns.read("/Temp/getPurchasedServerCost.12.txt") != result) await ns.write("/Temp/getPurchasedServerCost.12.txt", result, 'w'); }
