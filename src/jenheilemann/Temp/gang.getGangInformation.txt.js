...
export async function main(ns) {
      try
        { const result = JSON.stringify(ns.gang.getGangInformation(), jsonStringifyReplacer); if (ns.read("/Temp/gang.getGangInformation.txt") != result) await ns.write("/Temp/gang.getGangInformation.txt", result, 'w'); }
