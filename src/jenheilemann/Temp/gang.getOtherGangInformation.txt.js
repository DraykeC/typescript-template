...
export async function main(ns) {
      try
        { const result = JSON.stringify(ns.gang.getOtherGangInformation(), jsonStringifyReplacer); if (ns.read("/Temp/gang.getOtherGangInformation.txt") != result) await ns.write("/Temp/gang.getOtherGangInformation.txt", result, 'w'); }
