...
export async function main(ns) {
      try
        { const result = JSON.stringify(ns.getPurchasedServerCost(256), jsonStringifyReplacer); if (ns.read("/Temp/getPurchasedServerCost.8.txt") != result) await ns.write("/Temp/getPurchasedServerCost.8.txt", result, 'w'); }
