...
export async function main(ns) {
      try
        { const result = JSON.stringify(ns.getPurchasedServerCost(262144), jsonStringifyReplacer); if (ns.read("/Temp/getPurchasedServerCost.18.txt") != result) await ns.write("/Temp/getPurchasedServerCost.18.txt", result, 'w'); }
