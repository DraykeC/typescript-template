...
export async function main(ns) {
      try
        { const result = JSON.stringify(ns.getServer('pserv-17'), jsonStringifyReplacer); if (ns.read("/Temp/-510123522-data.txt") != result) await ns.write("/Temp/-510123522-data.txt", result, 'w'); }
