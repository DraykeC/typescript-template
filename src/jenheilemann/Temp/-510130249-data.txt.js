...
export async function main(ns) {
      try
        { const result = JSON.stringify(ns.getServer('pserv-10'), jsonStringifyReplacer); if (ns.read("/Temp/-510130249-data.txt") != result) await ns.write("/Temp/-510130249-data.txt", result, 'w'); }
