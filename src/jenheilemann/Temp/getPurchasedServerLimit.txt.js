...
export async function main(ns) {
      try
        { const result = JSON.stringify(ns.getPurchasedServerLimit(), jsonStringifyReplacer); if (ns.read("/Temp/getPurchasedServerLimit.txt") != result) await ns.write("/Temp/getPurchasedServerLimit.txt", result, 'w'); }
