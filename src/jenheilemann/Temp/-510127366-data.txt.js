...
export async function main(ns) {
      try
        { const result = JSON.stringify(ns.getServer('pserv-13'), jsonStringifyReplacer); if (ns.read("/Temp/-510127366-data.txt") != result) await ns.write("/Temp/-510127366-data.txt", result, 'w'); }
