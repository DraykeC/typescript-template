...
export async function main(ns) {
      try
        { const result = JSON.stringify(ns.getServer('pserv-16'), jsonStringifyReplacer); if (ns.read("/Temp/-510124483-data.txt") != result) await ns.write("/Temp/-510124483-data.txt", result, 'w'); }
