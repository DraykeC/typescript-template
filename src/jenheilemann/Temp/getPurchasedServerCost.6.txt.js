...
export async function main(ns) {
      try
        { const result = JSON.stringify(ns.getPurchasedServerCost(64), jsonStringifyReplacer); if (ns.read("/Temp/getPurchasedServerCost.6.txt") != result) await ns.write("/Temp/getPurchasedServerCost.6.txt", result, 'w'); }
