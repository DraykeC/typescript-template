...
export async function main(ns) {
      try
        { const result = JSON.stringify(ns.getPurchasedServerCost(1024), jsonStringifyReplacer); if (ns.read("/Temp/getPurchasedServerCost.10.txt") != result) await ns.write("/Temp/getPurchasedServerCost.10.txt", result, 'w'); }
