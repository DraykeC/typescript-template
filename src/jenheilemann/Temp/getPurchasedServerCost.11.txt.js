...
export async function main(ns) {
      try
        { const result = JSON.stringify(ns.getPurchasedServerCost(2048), jsonStringifyReplacer); if (ns.read("/Temp/getPurchasedServerCost.11.txt") != result) await ns.write("/Temp/getPurchasedServerCost.11.txt", result, 'w'); }
