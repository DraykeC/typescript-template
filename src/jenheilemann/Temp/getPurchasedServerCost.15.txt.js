...
export async function main(ns) {
      try
        { const result = JSON.stringify(ns.getPurchasedServerCost(32768), jsonStringifyReplacer); if (ns.read("/Temp/getPurchasedServerCost.15.txt") != result) await ns.write("/Temp/getPurchasedServerCost.15.txt", result, 'w'); }
