...
export async function main(ns) {
      try
        { const result = JSON.stringify(ns.getPurchasedServerCost(128), jsonStringifyReplacer); if (ns.read("/Temp/getPurchasedServerCost.7.txt") != result) await ns.write("/Temp/getPurchasedServerCost.7.txt", result, 'w'); }
