...
export async function main(ns) {
      try
        { const result = JSON.stringify(ns.getServer('pserv-23'), jsonStringifyReplacer); if (ns.read("/Temp/-510097575-data.txt") != result) await ns.write("/Temp/-510097575-data.txt", result, 'w'); }
