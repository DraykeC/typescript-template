...
export async function main(ns) {
      try
        { const result = JSON.stringify(ns.purchaseServer('pserv-24', 2), jsonStringifyReplacer); if (ns.read("/Temp/purchaseServer.txt") != result) await ns.write("/Temp/purchaseServer.txt", result, 'w'); }
