...
export async function main(ns) {
      try
        { const result = JSON.stringify(ns.getPurchasedServerCost(16384), jsonStringifyReplacer); if (ns.read("/Temp/getPurchasedServerCost.14.txt") != result) await ns.write("/Temp/getPurchasedServerCost.14.txt", result, 'w'); }
