...
export async function main(ns) {
      try
        { const result = JSON.stringify(ns.getServer('pserv-18'), jsonStringifyReplacer); if (ns.read("/Temp/-510122561-data.txt") != result) await ns.write("/Temp/-510122561-data.txt", result, 'w'); }
