...
export async function main(ns) {
      try
        { const result = JSON.stringify(ns.getServer('pserv-22'), jsonStringifyReplacer); if (ns.read("/Temp/-510098536-data.txt") != result) await ns.write("/Temp/-510098536-data.txt", result, 'w'); }
