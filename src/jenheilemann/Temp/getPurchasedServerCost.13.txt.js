...
export async function main(ns) {
      try
        { const result = JSON.stringify(ns.getPurchasedServerCost(8192), jsonStringifyReplacer); if (ns.read("/Temp/getPurchasedServerCost.13.txt") != result) await ns.write("/Temp/getPurchasedServerCost.13.txt", result, 'w'); }
