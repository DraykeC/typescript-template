...
export async function main(ns) {
      try
        { const result = JSON.stringify(ns.getPurchasedServerCost(8), jsonStringifyReplacer); if (ns.read("/Temp/getPurchasedServerCost.3.txt") != result) await ns.write("/Temp/getPurchasedServerCost.3.txt", result, 'w'); }
