...
export async function main(ns) {
      try
        { const result = JSON.stringify(ns.getServer('pserv-24'), jsonStringifyReplacer); if (ns.read("/Temp/-510096614-data.txt") != result) await ns.write("/Temp/-510096614-data.txt", result, 'w'); }
