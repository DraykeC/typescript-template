...
export async function main(ns) {
      try
        { const result = JSON.stringify(ns.getPurchasedServerCost(32), jsonStringifyReplacer); if (ns.read("/Temp/getPurchasedServerCost.5.txt") != result) await ns.write("/Temp/getPurchasedServerCost.5.txt", result, 'w'); }
