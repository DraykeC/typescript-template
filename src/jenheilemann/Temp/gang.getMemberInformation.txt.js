...
export async function main(ns) {
      try
        { const result = JSON.stringify(ns.gang.getMemberNames().map(m => ns.gang.getMemberInformation(m)), jsonStringifyReplacer); if (ns.read("/Temp/gang.getMemberInformation.txt") != result) await ns.write("/Temp/gang.getMemberInformation.txt", result, 'w'); }
