...
export async function main(ns) {
      try
        { const result = JSON.stringify(ns.getPurchasedServerCost(1048576), jsonStringifyReplacer); if (ns.read("/Temp/getPurchasedServerCost.20.txt") != result) await ns.write("/Temp/getPurchasedServerCost.20.txt", result, 'w'); }
