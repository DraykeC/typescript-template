...
export async function main(ns) {
      try
        { const result = JSON.stringify(ns.codingcontract.getData('contract-470634-CyberSec.cct', 'lexo-corp'), jsonStringifyReplacer); if (ns.read("/Temp/codingcontract.getData.txt") != result) await ns.write("/Temp/codingcontract.getData.txt", result, 'w'); }
