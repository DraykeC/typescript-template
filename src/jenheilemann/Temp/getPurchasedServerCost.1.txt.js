...
export async function main(ns) {
      try
        { const result = JSON.stringify(ns.getPurchasedServerCost(2), jsonStringifyReplacer); if (ns.read("/Temp/getPurchasedServerCost.1.txt") != result) await ns.write("/Temp/getPurchasedServerCost.1.txt", result, 'w'); }
