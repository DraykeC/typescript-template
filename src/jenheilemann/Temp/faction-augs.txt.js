...
export async function main(ns) {
      try
        { const result = JSON.stringify(ns.singularity.getAugmentationsFromFaction('Slum Snakes'), jsonStringifyReplacer); if (ns.read("/Temp/faction-augs.txt") != result) await ns.write("/Temp/faction-augs.txt", result, 'w'); }
